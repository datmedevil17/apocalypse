...
export function Characters_Shaun({ animation, weaponSlot, onAnimationFinished, ...props }: any) {
  const group = React.useRef<THREE.Group>(null!)
  const { scene, animations } = useGLTF('/models/Characters_Shaun-transformed.glb')
...
useGLTF.preload('/models/Characters_Shaun-transformed.glb')
