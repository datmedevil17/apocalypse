...
export function Characters_Lis_SingleWeapon({ animation, weaponSlot, onAnimationFinished, ...props }: any) {
  const group = React.useRef<THREE.Group>(null!)
  const { scene, animations } = useGLTF('/models/Characters_Lis_SingleWeapon-transformed.glb')
  ...
  useEffect(() => {
    ...
    // SingleWeapon models always show their baked-in weapon
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="Lis"
          geometry={nodes.Lis.geometry}
          material={materials.Atlas}
          skeleton={nodes.Lis.skeleton}
          castShadow
          receiveShadow
        />
      </group>
...
useGLTF.preload('/models/Characters_Lis_SingleWeapon-transformed.glb')
